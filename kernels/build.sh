...
OUT=${OUT:-libr9k.so}
HIPCC=${HIPCC:-hipcc}
SRCS=(r9k_moe_mxfp4a8.hip r9k_ple.hip r9k_gemm_fp8.hip third_party/davetha/r4d_lru.hip)
...
for sym in r9k_moe_mxfp4a8 r9k_moe_nvfp4a8 r9k_moe_4bit_prefill r9k_moe_prefill_bm r9k_quant_rows_fp8 r9k_silu_mul_quant_fp8 r9k_moe_block r9k_fold_supported r9k_ple_gather_int6 r9k_gemm_fp8 r9k_gemm_fp8_block r9k_quant_group128_fp8 r4d_lru_manage r4d_lru_gather r4d_lru_fused; do

...
OUT=${OUT:-libr9k.so}
HIPCC=${HIPCC:-hipcc}
SRCS=(r9k_moe_mxfp4a8.hip r9k_ple.hip r9k_gemm_fp8.hip r9k_ar.hip r9k_ar_wht.hip r9k_attn.hip third_party/davetha/r4d_lru.hip)

...
2026-09-21. Items marked **license pending** have no license file upstream; ask the authors before publishing
...
| libr4d 2-rank / N-rank P2P all-reduce (`r4d.so`, loaded at runtime) | libr4d + tcclaviger fork -- https://codeberg.org/tcclaviger/libr4d | `r9700_vllm/comm/r4d_ar.py` (default) | **license pending** |
| libr4d paged attention (`r4d.so`, loaded at runtime) | libr4d -- https://codeberg.org/StillDeadcode/libr4d | `r9700_vllm/attn/triton3d.py` (prefill / mixed batches) | **license pending** |
